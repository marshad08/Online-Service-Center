...
<body>
  <div class="mb-3 text-center mt-5 bg-primary" style="font-size: 30px;">
    <i class="fas fa-stethoscope"></i>
    <span>Online Maintenance Service Center</span>
  </div>
  ...
  <div class="container-fluid mb-5">
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4 bg-dark text-white" method="POST">
