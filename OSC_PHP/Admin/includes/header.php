...
<body>
 <!-- Top Navbar -->
 <nav class="navbar navbar-dark fixed-top bg-warning p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="dashboard.php">OSC</a>
 </nav>

 <!-- Side Bar -->
 <div class="container-fluid mb-5" style="margin-top:40px;">
  <div class="row">
   <nav class="col-sm-3 col-md-2 bg-warning sidebar py-5 d-print-none">
